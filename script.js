...
function onLoad(){
   ...
   onGetList )
   document.getElementById('btnGetRandom').addEventListener('click',
   onGetRandom)
}
...
async function onGetList(e){
    if(!txt.value) return alert("Trebuie sa introduci un numar")
    ...
    for(let  i = 0; i<cnt; i++){
        ...
        list.appendChild(creazaGluma(data))
    }

}


function creazaGluma(data){
